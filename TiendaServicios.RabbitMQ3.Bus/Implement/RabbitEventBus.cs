...
namespace TiendaServicios.RabbitMQ.Bus.Implement
{
    public class RabbitEventBus : IRabbitEventBus
    {
        ...
        public RabbitEventBus(IMediator mediator, IServiceScopeFactory scopeFactory)
        {
            _mediator = mediator;
        ...
        {
            var factory = new ConnectionFactory() { HostName = "rabbit-facu-web" };
